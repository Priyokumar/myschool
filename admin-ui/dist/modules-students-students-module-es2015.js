...
let AdmissionFeeCreateEditComponent = class AdmissionFeeCreateEditComponent extends _admission__WEBPACK_IMPORTED_MODULE_2__["Admission"] {
    constructor(http, router, activatedRoute, matDialog, snackBar) {
        super();
        this.http = http;
        this.router = router;
        ...
        this.paidAmountFormCtl.valueChanges.subscribe(data => {
            ...
            this.promiseToPayDateFormCtl.setValidators(_angular_forms__WEBPACK_IMPORTED_MODULE_9__["Validators"].required);
    ...
    getAdmissionFee() {
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_10__["ApiEndpoint"].ADMISSIONS + '/' + this.admId).subscribe(data => {
            this.admission = data.data;
            if (this.admission) {
                this.fees = this.admission.fees;
                this.feesDataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatTableDataSource"](this.fees);
            }
            this.setForm();
        }, err => {
            console.error(err);
    ...
    saveOrUpdateHttpObservable(admid, admissionPayloadData) {
        if (this.admId) {
    ...
    searchStudent() {
        const dialogRef = this.matDialog.open(_search_student_dialog_search_student_dialog_component__WEBPACK_IMPORTED_MODULE_8__["SearchStudentDialogComponent"], { width: '70%' })
    ...
    generateFees() {
        ...
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_10__["ApiEndpoint"].ADMISSIONS + '/fees/' + standard + '/' + acaYear).subscribe(data => {
            this.fees = data.data;
            this.feesDataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatTableDataSource"](this.fees);
        }, err => {
            console.error(err);
    ...
    getAddmissionFeeMaitenance(standard, academicYear) {
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_10__["ApiEndpoint"].ADDMISSION_FEE_MAINTENANCE + '/' + standard + '/' + academicYear + '/standard-year').subscribe(data => {
    ...
    pay(exptdateOfPayment) {
    }
};
AdmissionFeeCreateEditComponent.ctorParameters = () => [
...
let AdmissionFeeListComponent = class AdmissionFeeListComponent {
    ...
    getAdmissions() {
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["ApiEndpoint"].ADMISSIONS).subscribe(data => {
            this.admissions = data.data;
            this.admissionsDataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](this.admissions);
    ...
    onDeleteRow(admId) {
        ...
        this.dialog.open(src_app_modules_shared_components_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmationDialogComponent"], { width: '26%', data: confirmationData, disableClose: true })
            ...
            if (okData) {
                this.http.delete(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["ApiEndpoint"].ADMISSIONS + '/' + admId).subscribe(data => {
                    if (data.apiMessage && data.apiMessage.error) {
                    ...
                    this.admissionsDataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"]([]);
                    this.ngOnInit();
                }, err => {
                    console.error(err);
                    if (err.error && err.error.apiMessage) {
...
AdmissionFeeListComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
...
let AdmissionFeeViewComponent = class AdmissionFeeViewComponent {
    constructor(http, router, activatedRoute, dialog, snackBar, authService) {
        this.http = http;
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.dialog = dialog;
    ...
    getAdmission() {
        let resp;
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].ADMISSIONS + '/' + this.admId).subscribe(data => {
            resp = data;
            this.admission = resp.data;
            if (this.admission.fees) {
                this.feesDataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.admission.fees);
            }
        }, err => {
            console.error(err);
            if (err.error && err.error.apiMessage) {
    ...
    delete() {
        ...
        this.dialog.open(src_app_modules_shared_components_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmationDialogComponent"], { width: '26%', data: confirmationData, disableClose: true })
            .afterClosed().subscribe(okData => {
            if (okData) {
                this.http.delete(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].ADMISSIONS + '/' + this.admId).subscribe(data => {
                    if (data.apiMessage && data.apiMessage.error) {
                    ...
                    this.snackBar.openFromComponent(src_app_modules_shared_components_snackbar_info_snackbar_info_component__WEBPACK_IMPORTED_MODULE_7__["SnackbarInfoComponent"], Object.assign({ data: src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["SnackBarConfig"].dangerData(this.errorMessage) }, src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["SnackBarConfig"].flashTopDangerSnackBar()));
                });
            }
        });
    }
    ...
    payFee(fee) {
        this.dialog.open(src_app_modules_shared_components_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmationDialogComponent"], {
            ...
            .afterClosed().subscribe(okData => {
            if (okData) {
                this.http.put(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].ADMISSIONS + '/' + this.admId + '/fee/' + fee.id, {}).subscribe(data => {
                    this.getAdmission();
                    const configSuccess = {
                    ...
                    this.snackBar.openFromComponent(src_app_modules_shared_components_snackbar_info_snackbar_info_component__WEBPACK_IMPORTED_MODULE_7__["SnackbarInfoComponent"], Object.assign({ data: 'Successfully paid the fee.' }, configSuccess));
                }, err => {
                    console.error(err);
                    if (err.error && err.error.apiMessage) {
                        this.errorMessage = err.error.apiMessage.detail;
...
AdmissionFeeViewComponent.ctorParameters = () => [
...
let SearchStudentDialogComponent = class SearchStudentDialogComponent {
    ...
    getStudents() {
        ...
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STUDENTS).subscribe(data => {
            this.students = data.data;
            this.studentsDataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](this.students);
...
SearchStudentDialogComponent.ctorParameters = () => [
...
let StudentAttendenceCreateEditComponent = class StudentAttendenceCreateEditComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let StudentAttendenceListComponent = class StudentAttendenceListComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let StudentCreateEditComponent = class StudentCreateEditComponent extends _student__WEBPACK_IMPORTED_MODULE_2__["Student"] {
    ...
    getStandards() {
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_7__["ApiEndpoint"].STANDARD).subscribe(data => {
    ...
    getStudent() {
        let resp;
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_7__["ApiEndpoint"].STUDENTS + '/' + this.studId).subscribe(data => {
            resp = data;
    ...
    saveOrUpdateHttpObservable(studRegdId, studentPayloadData) {
        if (this.studId) {
...
StudentCreateEditComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
...
let StudentListComponent = class StudentListComponent {
    ...
    getStudents() {
        let resp;
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["ApiEndpoint"].STUDENTS).subscribe(data => {
            resp = data;
    ...
    onDeleteRow(studId) {
        ...
        this.dialog.open(src_app_modules_shared_components_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmationDialogComponent"], { width: '26%', data: confirmationData, disableClose: true })
            .afterClosed().subscribe(okData => {
            if (okData) {
                this.http.delete(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["ApiEndpoint"].STUDENTS + '/' + studId).subscribe(data => {
                    if (data.apiMessage && data.apiMessage.error) {
                        this.snackBar.openFromComponent(src_app_modules_shared_components_snackbar_info_snackbar_info_component__WEBPACK_IMPORTED_MODULE_7__["SnackbarInfoComponent"], Object.assign({ data: src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["SnackBarConfig"].dangerData(data.apiMessage.detail) }, src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["SnackBarConfig"].flashTopDangerSnackBar()));
                        return;
                    }
...
let StudentViewComponent = class StudentViewComponent {
    constructor(http, router, activatedRoute, dialog, fileUploadService, snackBar, authService) {
        this.http = http;
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.dialog = dialog;
    ...
    getStudent() {
        let resp;
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STUDENTS + '/' + this.studId).subscribe(data => {
            resp = data;
            this.student = resp.data;
            if (this.student.profilePic) {
                this.profilePicUrl = src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].DOCUMENT + '/' + this.student.profilePic.id + '/view';
            }
        }, err => {
            console.error(err);
            if (err.error && err.error.apiMessage) {
    ...
    delete() {
        ...
        this.dialog.open(src_app_modules_shared_components_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmationDialogComponent"], { width: '26%', data: confirmationData, disableClose: true })
            .afterClosed().subscribe(okData => {
            if (okData) {
                this.http.delete(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STUDENTS + '/' + this.studId).subscribe(data => {
                    if (data.apiMessage && data.apiMessage.error) {
                        this.snackBar.openFromComponent(src_app_modules_shared_components_snackbar_info_snackbar_info_component__WEBPACK_IMPORTED_MODULE_8__["SnackbarInfoComponent"], Object.assign({ data: src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["SnackBarConfig"].dangerData(data.apiMessage.detail) }, src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["SnackBarConfig"].flashTopDangerSnackBar()));
                        return;
                    }
    ...
    onSelectFile(file) {
        this.fileUploadService.uploadDoc(file, this.studId, 'STUDENT', 'PROFILE_PIC', 'PROFILE_PIC').subscribe(event => {
            ...
            if (event.type === _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpEventType"].UploadProgress) {
                ...
                const docUrl = src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].DOCUMENT + '/' + body.actionMessage + '/view';
...
const AdmissionStatuses = ['Admitted', 'Expired'];
...
const StudentStatuses = ['Active', 'Inactive'];
const Genders = [
    { key: 'MALE', value: 'Male' },
