...
let AdmissionFeeStructureDialogComponent = class AdmissionFeeStructureDialogComponent {
    ...
    getStandard() {
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STANDARD).subscribe(data => {
...
AdmissionFeeStructureDialogComponent.ctorParameters = () => [
...
let AdmissionfeeStructureCreateEditComponent = class AdmissionfeeStructureCreateEditComponent {
    constructor(http, router, activatedRoute, commonService, dialog, snackBar) {
        this.http = http;
        this.router = router;
    ...
    getAdmFeeStructureYearly() {
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_8__["ApiEndpoint"].ADDMISSION_FEE_MAINTENANCE + '/' + this.admFeeStructureYearlId).subscribe(data => {
    ...
    save() {
        const admFeeStructureYearlyPayload = {
        ...
        this.saveOrUpdateHttpObservable(admFeeStructureYearlyPayload).subscribe(data => {
            ...
            this.snackBar.openFromComponent(src_app_modules_shared_components_snackbar_info_snackbar_info_component__WEBPACK_IMPORTED_MODULE_9__["SnackbarInfoComponent"], Object.assign({ data: src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_8__["SnackBarConfig"].dangerData(this.errorMessage) }, src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_8__["SnackBarConfig"].flashTopDangerSnackBar()));
        });
    }
    saveOrUpdateHttpObservable(admFeeStructureYearlyPayload) {
        if (this.admFeeStructureYearlId) {
    ...
    addAdmFeeStructure() {
        const dialogRef = this.dialog.open(_admission_fee_structure_dialog_admission_fee_structure_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AdmissionFeeStructureDialogComponent"], { width: '60%' })
    ...
    edit(index, admFeeMaint) {
        const dialogRef = this.dialog.open(_admission_fee_structure_dialog_admission_fee_structure_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AdmissionFeeStructureDialogComponent"], { width: '60%', data: admFeeMaint })
            .afterClosed().subscribe(data => {
            if (data) {
...
AdmissionfeeStructureCreateEditComponent.ctorParameters = () => [
...
let AdmissionfeeStructureListComponent = class AdmissionfeeStructureListComponent {
    constructor(http, router, dialog, snackBar) {
        this.http = http;
        this.router = router;
        this.dialog = dialog;
        this.snackBar = snackBar;
    ...
    getAdmFeeStructures() {
        let resp;
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["ApiEndpoint"].ADDMISSION_FEE_MAINTENANCE).subscribe(data => {
            resp = data;
            if (resp && !resp.apiMessage.error) {
                this.admFeeStructures = resp.data;
                this.admFeeStructureDataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.admFeeStructures);
                if (!this.admFeeStructures) {
    ...
    onDeleteRow(admFeeStructureId) {
        ...
        this.dialog.open(src_app_modules_shared_components_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmationDialogComponent"], { width: '26%', data: confirmationData, disableClose: true })
            ...
            if (okData) {
                this.http.delete(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["ApiEndpoint"].ADDMISSION_FEE_MAINTENANCE + '/' + admFeeStructureId).subscribe(data => {
                    if (data.apiMessage && data.apiMessage.error) {
                    ...
                    this.admFeeStructureDataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"]([]);
                    this.getAdmFeeStructures();
                }, err => {
                    console.error(err);
                    if (err.error && err.error.apiMessage) {
...
AdmissionfeeStructureListComponent.ctorParameters = () => [
...
let AdmissionfeeStructureViewComponent = class AdmissionfeeStructureViewComponent {
    constructor(http, router, activatedRoute, dialog, snackBar) {
        this.http = http;
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.dialog = dialog;
    ...
    getAdmFeeStructure() {
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["ApiEndpoint"].ADDMISSION_FEE_MAINTENANCE + '/' + this.admFeeStructureId).subscribe(data => {
            this.admFeeStructure = data.data;
            this.admFeeStructures = this.admFeeStructure.maintenanceAdmissionFees;
            this.admFeeStructureDataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](this.admFeeStructures);
    ...
    delete() {
        ...
        this.dialog.open(src_app_modules_shared_components_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmationDialogComponent"], { width: '26%', data: confirmationData, disableClose: true })
            .afterClosed().subscribe(okData => {
            if (okData) {
                this.http.delete(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["ApiEndpoint"].ADDMISSION_FEE_MAINTENANCE + '/' + this.admFeeStructureId).subscribe(data => {
                    if (data.apiMessage && data.apiMessage.error) {
                        this.snackBar.openFromComponent(src_app_modules_shared_components_snackbar_info_snackbar_info_component__WEBPACK_IMPORTED_MODULE_7__["SnackbarInfoComponent"], Object.assign({ data: src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["SnackBarConfig"].dangerData(data.apiMessage.detail) }, src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["SnackBarConfig"].flashTopDangerSnackBar()));
                        return;
                    }
...
AdmissionfeeStructureViewComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
let ClassCreateEditComponent = class ClassCreateEditComponent {
    ...
    getStandard() {
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["ApiEndpoint"].STANDARD + '/' + this.standardId).subscribe(data => {
    ...
    save() {
        ...
        this.saveOrUpdateHttpObservable(standardPayload).subscribe(data => {
            if (data.apiMessage && data.apiMessage.error) {
                this.snackBar.openFromComponent(src_app_modules_shared_components_snackbar_info_snackbar_info_component__WEBPACK_IMPORTED_MODULE_6__["SnackbarInfoComponent"], Object.assign({ data: src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["SnackBarConfig"].dangerData(data.apiMessage.detail) }, src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["SnackBarConfig"].flashTopDangerSnackBar()));
                return;
            }
            else {
                this.snackBar.openFromComponent(src_app_modules_shared_components_snackbar_info_snackbar_info_component__WEBPACK_IMPORTED_MODULE_6__["SnackbarInfoComponent"], Object.assign({ data: src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["SnackBarConfig"].successData(data.apiMessage.detail) }, src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["SnackBarConfig"].flashTopSuccessSnackBar()));
    ...
    saveOrUpdateHttpObservable(standardPayload) {
        if (this.standardId) {
...
ClassCreateEditComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
...
let ClassListComponent = class ClassListComponent {
    ...
    getStandards() {
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["ApiEndpoint"].STANDARD).subscribe(data => {
    ...
    onDeleteRow(standardId) {
        ...
        this.dialog.open(src_app_modules_shared_components_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmationDialogComponent"], { width: '26%', data: confirmationData, disableClose: true })
            .afterClosed().subscribe(okData => {
            if (okData) {
                this.http.delete(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["ApiEndpoint"].STANDARD + '/' + standardId).subscribe(data => {
                    if (data.apiMessage && data.apiMessage.error) {
                        this.snackBar.openFromComponent(src_app_modules_shared_components_snackbar_info_snackbar_info_component__WEBPACK_IMPORTED_MODULE_7__["SnackbarInfoComponent"], Object.assign({ data: src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["SnackBarConfig"].dangerData(data.apiMessage.detail) }, src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_5__["SnackBarConfig"].flashTopDangerSnackBar()));
                        return;
                    }
...
let ClassViewComponent = class ClassViewComponent {
    constructor(http, router, activatedRoute, dialog, snackBar) {
        this.http = http;
        this.router = router;
        this.activatedRoute = activatedRoute;
    ...
    getStandard() {
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STANDARD + '/' + this.standardId).subscribe(data => {
            this.standard = data.data;
            this.getStudents();
        }, err => {
            console.error(err);
    ...
    delete() {
        ...
        this.dialog.open(src_app_modules_shared_components_confirmation_dialog_confirmation_dialog_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmationDialogComponent"], { width: '26%', data: confirmationData, disableClose: true })
            .afterClosed().subscribe(okData => {
            if (okData) {
                this.http.delete(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STANDARD + '/' + this.standardId).subscribe(data => {
                    if (data.apiMessage && data.apiMessage.error) {
    ...
    getStudents() {
        this.http.get(src_app_modules_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STUDENTS, { params: { standard: this.standard.name } }).subscribe(data => {
...
ClassViewComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
