...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-dashboard-dashboard-module"], {
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            (function (global, factory) {
                true ? module.exports = factory(function () { try {
                ...
                */
                ...
                var scale_radialLinear = scale_linearbase.extend({
                    ...
                    getBasePosition: function (index) {
                        ...
                        var min = me.min;
                        var max = me.max;
                        return me.getPointPositionForValue(index || 0, me.beginAtZero ? 0 :
                            min < 0 && max < 0 ? max :
                                min > 0 && max > 0 ? min :
                                    0);
                    },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony default export */ __webpack_exports__["default"] = ("<div class=\"row\">\n\n    <div class=\"col-md-6 pl-1 pr-1 pb-1 pt-0\">\n        <div class=\"mat-elevation-z1 bg-light-gold-gradient p-3\">\n            \n            <div class=\"d-flex justify-content-end align-items-center\">\n                <!-- <div>\n                    <button mat-icon-button>\n                        <mat-icon>more_vert</mat-icon>\n                    </button>\n                </div> -->\n            </div>\n\n            <div class=\"d-flex align-items-center justify-content-center\">\n                <div class=\"text-center p-3\">\n                    <span class=\"display-4\">{{employees.length}}</span>\n                </div>\n                <div>\n                    <a [routerLink]=\"'/admin/employees'\">\n                        <span class=\"font-title-md font-secondary-blue\">Employees</span>\n                    </a>\n                </div>\n            </div>\n        </div>\n    </div>\n\n    <div class=\"col-md-6 pl-1 pr-1 pb-1 pt-0\">\n        <div class=\"mat-elevation-z1 bg-light-gold-gradient p-3\">\n            <div class=\"d-flex justify-content-end align-items-center\">\n                <!-- <div>\n                    <button mat-icon-button>\n                        <mat-icon>more_vert</mat-icon>\n                    </button>\n                </div> -->\n            </div>\n            <div class=\"d-flex align-items-center justify-content-center\">\n                <div class=\"p-3\">\n                    <span class=\"display-4\">{{teachingStaffs.length}}</span>\n                </div>\n                <div>\n                    <a>\n                        <span class=\"font-title-md font-secondary-blue\">Teaching Staffs</span>\n                    </a>\n                </div>\n            </div>\n        </div>\n    </div>\n\n    <div class=\"col-md-12 p-1\"></div>\n\n    <div class=\"col-md-6 p-1\">\n        <div class=\"mat-elevation-z1 bg-light-gold-gradient p-3\">\n            <div class=\"d-flex justify-content-between align-items-center\">\n                <div>\n                    <a routerLink=\"/admin/students\">\n                        <span class=\"font-title-md font-secondary-blue\">Students({{allStudents.length}})</span>\n                    </a>\n                </div>\n                <!-- <div>\n                    <button mat-icon-button>\n                        <mat-icon>more_vert</mat-icon>\n                    </button>\n                </div> -->\n            </div>\n            <canvas id=\"student-bar-chart\" height=\"135vh\"></canvas>\n        </div>\n    </div>\n\n    <div class=\"col-md-6 p-1\">\n        <div class=\"mat-elevation-z1 bg-light-gold-gradient p-3\">\n            <div class=\"d-flex justify-content-between align-items-center\">\n                <div>\n                    <a routerLink=\"/admin/students/admissions\">\n                        <span class=\"font-title-md font-secondary-blue\">Admissions({{totalAdmission}})</span>\n                    </a>\n                </div>\n                <!-- <div>\n                    <button mat-icon-button>\n                        <mat-icon>more_vert</mat-icon>\n                    </button>\n                </div> -->\n            </div>\n            <canvas id=\"admission-line-chart\" height=\"135vh\"></canvas>\n        </div>\n    </div>\n\n</div>");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminDashboardComponent = /** @class */ (function () {
                function AdminDashboardComponent(http) {
                    ...
                    this.students = [];
                    this.standards = [];
                    this.studentsBarChartLabels = [];
                    this.studentsBarChartData = [];
                    this.studentsBarChartDBgColor = [];
                    this.studentsBarChartDBorderColor = [];
                    this.allStudents = [];
                    this.admissionDashboardData = [];
                    this.employees = [];
                    this.teachingStaffs = [];
                }
                ...
                AdminDashboardComponent.prototype.getAllStudents = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 2, , 3]);
                                    return [4 /*yield*/, this.http.get(_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STUDENTS).toPromise()];
                                case 1:
                                    resp = _a.sent();
                ...
                AdminDashboardComponent.prototype.getStandards = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var resp, error_2;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 3, , 4]);
                                    return [4 /*yield*/, this.http.get(_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STANDARD).toPromise()];
                                case 1:
                                    resp = _a.sent();
                                    this.standards = resp.data;
                                    return [4 /*yield*/, this.getStudentsByStandard()];
                                case 2:
                                    _a.sent();
                ...
                AdminDashboardComponent.prototype.getStudentsByStandard = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _i, _a, standard;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    _i = 0, _a = this.standards;
                                    _b.label = 1;
                                case 1:
                                    if (!(_i < _a.length)) return [3 /*break*/, 4];
                                    standard = _a[_i];
                                    return [4 /*yield*/, this.getStudents(standard)];
                                case 2:
                                    _b.sent();
                                    _b.label = 3;
                                case 3:
                ...
                AdminDashboardComponent.prototype.getEmployees = function () {
                    var _this = this;
                    this.http.get(_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].EMPLOYEES).subscribe(function (data) {
                        _this.employees = data.data;
                        _this.teachingStaffs = _this.employees.filter(function (employee) {
                ...
                AdminDashboardComponent.prototype.getAdmissionByYear = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _a, error_3;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _b.trys.push([0, 2, , 3]);
                                    _a = this;
                                    return [4 /*yield*/, this.http.get(_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].ADMISSIONS + '/year/' + new Date().getFullYear()).toPromise()];
                                case 1:
                                    _a.admissionDashboardData = _b.sent();
                ...
                AdminDashboardComponent.prototype.getStudents = function (standard) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var resp, bg, brd, error_4;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 2, , 3]);
                                    return [4 /*yield*/, this.http.get(_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STUDENTS, { params: { standard: standard.name } }).toPromise()];
                                case 1:
                                    resp = _a.sent();
                                    this.studentsBarChartLabels.push(standard.name);
                                    bg = "rgba(141, 182, 0,0.4)";
                                    brd = "rgba(141, 182, 0,1)";
                ...
                AdminDashboardComponent.prototype.drawStudentsBarChart = function () {
                    if (this.studentsBarChart) {
                        this.studentsBarChart.clear();
                    }
                    this.studentsBarChart = new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a('student-bar-chart', {
                        type: 'bar',
                        data: {
                ...
                AdminDashboardComponent.prototype.drawAdmissionLineChart = function (admissionsData) {
                    var months = admissionsData.map(function (admission) {
                        return admission.month;
                    });
                    var counts = admissionsData.map(function (admission) {
                        return admission.count;
                    });
                    this.totalAdmission = counts.reduce(function (total, count) {
                        return total + count;
                    });
                    this.admissionLineChart = new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a('admission-line-chart', {
                        type: 'line',
                        data: {
                            labels: months,
                            datasets: [{
                ...
                AdminDashboardComponent.prototype.generateRandomColor = function () {
