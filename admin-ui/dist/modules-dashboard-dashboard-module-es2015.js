...
let AdminDashboardComponent = class AdminDashboardComponent {
    ...
    getAllStudents() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                const resp = yield this.http.get(_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STUDENTS).toPromise();
    ...
    getStandards() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                const resp = yield this.http.get(_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STANDARD).toPromise();
                this.standards = resp.data;
                yield this.getStudentsByStandard();
    ...
    getStudentsByStandard() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            for (const standard of this.standards) {
                yield this.getStudents(standard);
            }
        });
    }
    getEmployees() {
        this.http.get(_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].EMPLOYEES).subscribe(data => {
    ...
    getAdmissionByYear() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                this.admissionDashboardData = yield this.http.get(_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].ADMISSIONS + '/year/' + new Date().getFullYear()).toPromise();
    ...
    getStudents(standard) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                const resp = yield this.http.get(_shared_model_shared_model__WEBPACK_IMPORTED_MODULE_4__["ApiEndpoint"].STUDENTS, { params: { standard: standard.name } }).toPromise();
    ...
    drawAdmissionLineChart(admissionsData) {
